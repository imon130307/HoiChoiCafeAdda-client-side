const MenuItem = ({ item }) => {
  return (
    <div className="flex flex-col items-center sm:flex sm:flex-row md:h-[104px] sm:items-start justify-between  rounded-lg hover:scale-105 transition-all duration-300 gap-4 md:gap-8">
